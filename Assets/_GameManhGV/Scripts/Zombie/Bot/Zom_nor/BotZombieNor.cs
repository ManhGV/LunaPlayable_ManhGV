...
public class BotZombieNor : MonoBehaviour
{
    ...
    public Dictionary<BotZomNorState, StateBase<BotZomNorState, BotNetwork>> stateController = new Dictionary<BotZomNorState, StateBase<BotZomNorState, BotNetwork>>();

    public StateBase<BotZomNorState, BotNetwork> _currentState;
