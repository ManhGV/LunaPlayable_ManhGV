...
public class Weapon112 : NoReloadWeapons
{
    ...
    [SerializeField] float _animPincersOpenSpeed;  // tốc độ mở càng - 30
    [SerializeField] float _animPincersCloseSpeed; // tốc độ đóng càng - 50
    [SerializeField] float _desiredAngle; // - 30
    [SerializeField] float _animBodyShoodSpeed;// - 2
    [SerializeField] float _animBodyHouldSpeed;// -.1
    [SerializeField] float _multiplierSpdOnRealease = 1; // -10
    [SerializeField] float maxZHold;  // Max Z value when holding the weapon -0
    [SerializeField] float maxZShoot; // Max Z value when shooting -.15
